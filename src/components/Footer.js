...
function Footer() {
    return (
        <footer className="text-left text-dark footer--pin" style={{ backgroundColor: "rgba(0, 0, 0, 0.2)", position: "relative", left: 0, bottom: 0, right: 0, maxHeight: "calc(100vh - 67px)" }}>
